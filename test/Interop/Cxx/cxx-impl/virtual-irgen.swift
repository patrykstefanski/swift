...
// CHECK-SYSV: @_ZTV9MIDerived = {{(dso_local )?}}unnamed_addr constant { [7 x ptr], [3 x ptr] } { [7 x ptr] [ptr null, ptr @_ZTI9MIDerived, ptr @[[MI_COMPLETE_DTOR:_ZN9MIDerivedD[12]Ev]], ptr @_ZN9MIDerivedD0Ev, ptr @_ZN9MIDerived6firstAEv, ptr @_ZN9MIDerived8miAnchorEv, ptr @_ZNK9MIDerived5fromBEv],
...
extension MIDerived {
  ...
  // destructor makes virtual, so its body is emitted too. The complete
  // destructor (D1) is replaced by the base one (D2) only where constructor
  // aliases are enabled, which is not the case on Darwin.
