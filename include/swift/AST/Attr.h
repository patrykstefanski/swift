...
public:
  ...
  /// identifier). This is the unqualified C++ source name the importer looks
  /// up; it is not a mangled symbol. The emitted symbol comes from the matched
  /// C++ declaration's Itanium mangling.
  const StringRef Name;
